        ...
        switch (type) {
            ...
            case BUDS:
                devices = new EasySetupDevice[]{
                        ...
                        new EasySetupDevice("0x123456", "Ocean Blue Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x654321", "Forest Green Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x789ABC", "Sunset Orange Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0xDEF123", "Midnight Black Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x456789", "Rose Gold Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0xABC123", "Electric Yellow Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x321654", "Crimson Red Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x987654", "Arctic White Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x654987", "Mystic Purple Buds", EasySetupDevice.type.BUDS),
                        new EasySetupDevice("0x321987", "Golden Buds", EasySetupDevice.type.BUDS)
                };
                break;
            case WATCH:
                devices = new EasySetupDevice[]{
                        ...
                        new EasySetupDevice("0x21", "Midnight Black Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x22", "Ocean Blue Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x23", "Rose Gold Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x24", "Electric Yellow Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x25", "Crimson Red Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x26", "Arctic White Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x27", "Mystic Purple Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x28", "Golden Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x29", "Forest Green Watch6", EasySetupDevice.type.WATCH),
                        new EasySetupDevice("0x2A", "Sunset Orange Watch6", EasySetupDevice.type.WATCH)
                };
                break;
        }
